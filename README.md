...
## [(주)컴파이드] Paint Color Formulation AI
...
## [Team Project] Image Inpainting & Colorization
...
- Django 공식 문서를 중심으로 한 달간 집중 학습한 뒤 솔루션개발팀 업무에 참여했습니다.
- React Flow를 활용해 사용자가 편집할 수 있는 플로우차트의 노드와 엣지를 개발했습니다.
- 편집 상태를 Session Storage에 저장해 브라우저에서 작업 내용을 유지하도록 구현했습니다.
- 블록 코딩과 로봇 디바이스 교육 지원 경험을 바탕으로 사용자 관점에서 기능을 검수하고 개선했습니다.
